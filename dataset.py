...
def deepbug_chronological_cv(dataset_name, min_train_samples_per_class, num_cv, merged_wordvec_model):
    # Load preprocessed data
    wordvec_model, sentences, labels = load_data(
        dataset_name, min_train_samples_per_class, merged_wordvec_model
    )
    ...
    for i in range(1, num_cv + 1):
        ...
        yield CNN_train, RNN_train, y_train, CNN_test, RNN_test, y_test, classes